  ...
  return (
    <div className="flex text-center justify-center items-center flex-col pt-[90px]">
      <div className='mb-80 mt-60 '>
        ...
        <div className="txt-ternary-light lg:text-[20px] mt-5 md:flex-row flex mobile:flex-col justify-center">
      ...
      <div className=" font-bold txt-main mt-[10rem] mobile:text-[40px] lg:text-[64px] mobile:flex-col flex lg:flex-row">
      ...
      <div className=" font-bold txt-light mt-[10rem] mobile:text-[40px] lg:text-[64px] flex mobile:flex-col lg:flex-row">
        How does it <span className="txt-main">&nbsp;Work</span>
      </div>
      <div className="flex lg:flex-row mobile:flex-col mb-40">
      ...
      <div className=" font-bold txt-main mt-[10rem] mobile:text-[40px] lg:text-[64px] flex mobile:flex-col lg:flex-row">
