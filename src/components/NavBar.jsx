...
const NavBar = () => {
  return (
    <div className="lg:text-[26px]  w-full h-[90px] flex text-5xl items-center justify-around font-normal shadow-md fixed z-30 back-light txt-ternary-light">
      <div className="cursor-pointer mobile:text-[20px] lg:text-[26px] ">
